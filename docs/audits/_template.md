---
date: YYYY-MM-DD
surface: <lesson-pages | marketing-dashboard | other>
tooling_used:
  - <e.g. "@axe-core/cli@<version>">
  - <e.g. "Lighthouse 12 (Chrome DevTools)">
  - <e.g. "manual keyboard walk">
  - <e.g. "manual screen-reader walk (Orca 44)">
status: <draft | complete>
site_commit: <short-sha-of-deployed-site-at-audit-time>
---

# <Surface name> — Accessibility & Readability Audit
