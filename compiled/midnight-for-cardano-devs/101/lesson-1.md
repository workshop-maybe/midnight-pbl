# Scaffold and Deploy Your First Midnight DApp
...
- **Compact compiler** installed: `npm install -g @midnight-ntwrk/compact@0.29.0`

Version pinning matters. The latest Compact compiler (0.30.0) breaks with SDK 3.0.0. Use 0.29.0:
...
| Compilation fails with version error | Compact 0.30.0 vs SDK 3.0.0 mismatch | `compact update 0.29.0` |
...
| Component | Version |
|-----------|---------|
| Compact compiler (`compactc`) | 0.29.0 |
...
On Cardano, the loop is: write validator, build transaction, submit. No proof server, no ZK compilation, no privacy layer. The extra steps on Midnight are the cost of privacy infrastructure.
